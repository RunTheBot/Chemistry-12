...
\begin{enumerate}
    \item 
    Using value calculated in Analysis of Part 1 and Part 2 from data in Table \ref{tab:observations-small} and \ref{tab:observations-large}, the percentage error for the method from Part 2 was calculated as follows:
    \begin{align*}
...
\end{enumerate}
\section{Conclusion}
The density of the small rubber stopper was approximately 2.6 g/cm$^3$, and the density of the large rubber stopper was approximately 1.567 g/cm$^3$. A lab report was written with proper formatting.
\end{document}