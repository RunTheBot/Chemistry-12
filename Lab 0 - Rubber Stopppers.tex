...
Glassware was handled with care to avoid breakage or spills. Broken glass was disposed of by qualified personnel.
...
\begin{center}
    \begin{tikzpicture}[line width=1pt]
        ...
        \lstep{Mass Scale}
        \rstep{Mass of the large rubber stopper was measured}
        \rstep{Initial mass of the watch glass was measured}
        ...
        \lstep{Mass Scale}
        \rstep{Final mass of the watch glass with collected water was measured}
...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \end{align*}
\end{minipage}\\
$\therefore$ the density of the small rubber stopper was approximately 2.6 g/cm$^3$.
...
\end{minipage}
\vspace{0.125 in}\\
$\therefore$ the density of the large rubber stopper was approximately 1.567 g/cm$^3$.
\section{Discussion}
...
\begin{enumerate}
    \item 
    Using value from Analysis of Part 1 and Part 2:
    \begin{align*}
    ...
    $\therefore$ the percentage error for the method from Part 2 was approximately 38.5\%.
...
\newpage
\section{Conclusion}
The density of the small rubber stopper was approximately 2.6 g/cm$^3$, and the density of the large rubber stopper was approximately 1.567 g/cm$^3$. The percentage error for the method from Part 2 was approximately 38.5\%. A full lab report was written with a detailed procedure flowchart, observations table, analysis, and discussion of results.
\end{document}