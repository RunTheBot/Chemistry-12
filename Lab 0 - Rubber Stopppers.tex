...
Density is a physical property that describes the relationship between the mass of a material and its volume. This property may be used to identify a material and can be used to compare two different materials. Density is the ratio calculated using  $\rho = \frac{m}{V}$, where $\rho$ is the density, $m$ is the mass, and $V$ is the volume. 

This lab will use the displacement of water to determine the volume of the rubber stoppers, which in addition to the mass taken on a mass scale, will then be used to calculate the densities of two rubber stoppers. This lab will explore two different methods of finding the volume of the rubber stoppers, one for each size, due to the lab's constraint of not being able to use a larger graduated cylinder. The smaller rubber stopper will be measured using a graduated cylinder, while the larger rubber stopper will be measured using a beaker overflowing into a watch glass, where the change in mass of the watch glass will be used to determine the volume.
...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \end{align*}
\end{minipage}\\
$\therefore$ the density of the small rubber stopper is approximately 2.6 g/cm$^3$.
...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \end{align*}
\end{minipage}\\
$\therefore$ the density of the large rubber stopper is approximately 1.567 g/cm$^3$.
\section{Discussion}
